-- Railway PostgreSQL fixes for ERRORS 3 & 4

-- ERROR 3: Create missing bloom_context table
...
-- ERROR 4: Fix Sarah's identity
UPDATE agents SET
  role = 'Content & Digital Marketing Executive',
  client = 'BLOOM Ecosystem'
WHERE id = 'bloomie-sarah-rodriguez';

-- Clear old chat messages (remove old Youth Empowerment School context)
...
SELECT COUNT(*) as bloom_context_table_created FROM information_schema.tables WHERE table_name = 'bloom_context';