 ...
 */
export declare function checkAccess(planTier: PlanTier | string, toolName: string): AccessResult;
/** Return a summary of what each tier includes, for the check_access tool. */
export declare function getPlanSummary(currentTier: PlanTier | string): string;
