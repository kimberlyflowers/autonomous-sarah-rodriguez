...
- Website registry: `list_websites`, `register_website`, `publish_website`
- Pages: `get_site_pages`, `upsert_site_page`
- Events: `list_site_events`, `upsert_site_event`, `set_homepage_feature`
