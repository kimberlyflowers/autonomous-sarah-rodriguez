...
export async function searchGoogleMaps(params) {
    ...
    if (!apiKey) {
        errors.push("Outscraper API key not configured. " +
    ...
    try {
        ...
        const data = await fetchJson(OUTSCRAPER_API, {
            params: {
                query: searchQuery,
        ...
        if (results.length === 0) {
            errors.push(`No Google Maps results for "${params.query}" in "${params.location}". ` +
...
//# sourceMappingURL=search-google-maps.js.map