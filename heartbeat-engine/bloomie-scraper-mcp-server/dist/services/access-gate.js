import { PlanTier, TIER_ACCESS, UPSELL_MESSAGES, } from "../constants.js";
/**
 * Check whether a plan tier has access to a given tool.
 * If not, returns the upsell message for that tool.
 */
export function checkAccess(planTier, toolName) {
    ...
    return {
        allowed: false,
        upsellMessage: UPSELL_MESSAGES[toolName] ??
...
export function getPlanSummary(currentTier) {
    const lines = [
