...
import {
  ...
  SearchFacebookGroupsSchema,
  SearchGoogleMapsSchema,
  SearchApolloSchema,
  SearchLinkedInSchema,
} from "./schemas/inputs.js";
import type {
  CheckAccessInput,
  ScrapeUrlInput,
  SearchBusinessesInput,
  SearchFacebookGroupsInput,
...
function gatedResponse(toolName: string, planTier: PlanTier) {
...
Returns:
  ...
  async (params: SearchBusinessesInput) => {
...
Returns:
  ...
  async (params: SearchFacebookGroupsInput) => {
...
Returns:
  ...
  async (params: SearchGoogleMapsInput) => {
...
Returns:
  ...
  async (params: SearchApolloInput) => {
...
Returns:
  ...
  async (params: SearchLinkedInInput) => {
